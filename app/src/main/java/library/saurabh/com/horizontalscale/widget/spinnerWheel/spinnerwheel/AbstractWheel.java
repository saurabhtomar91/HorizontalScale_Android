...
package library.saurabh.com.horizontalscale.widget.spinnerWheel.spinnerwheel;
...
import library.saurabh.com.horizontalscale.widget.spinnerWheel.adapters.FloatingWheelAdapter;
import library.saurabh.com.horizontalscale.widget.spinnerWheel.adapters.WheelViewAdapter;


import library.saurabh.com.horizontalscale.R;
/**
...
public abstract class AbstractWheel extends View {
    ...
    private List<OnWheelChangedFloatListener> changingFloatListeners = new LinkedList<OnWheelChangedFloatListener>();
    ...
    public void setCurrentItem(int index, boolean animated) {
        ...
        if (index != mCurrentItemIdx) {
            if (animated) {
                ...
                if(mViewAdapter instanceof FloatingWheelAdapter) {
                    float oldFloat = ((float)old)/10;
                    float newFloat = ((float)mCurrentItemIdx)/10;
                    notifyChangingListeners(oldFloat, newFloat);
                }else {
    ...
    public void setCurrentItem(float index) {
        if(mViewAdapter instanceof FloatingWheelAdapter) {
            index = index*10;
        }
        setCurrentItem((int)index, false);
    }
    ...
    public void addChangingFloatListener(OnWheelChangedFloatListener listener) {
        changingFloatListeners.add(listener);
    }
    ...
    public void removeChangingFloatListener(OnWheelChangedFloatListener listener) {
        changingFloatListeners.remove(listener);
    }
    ...
    protected void notifyChangingListeners(float oldValue, float newValue) {
        for (OnWheelChangedFloatListener listener : changingFloatListeners) {
            listener.onChanged(this, oldValue, newValue);
        }
    }
